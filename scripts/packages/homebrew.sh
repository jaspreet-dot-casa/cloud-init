...
do_install() {
    ...
    # Re-detect brew prefix after installation and initialize environment
    BREW_PREFIX=$(get_brew_prefix) || true
...
# Initialize Homebrew environment (supports Linux and macOS)
